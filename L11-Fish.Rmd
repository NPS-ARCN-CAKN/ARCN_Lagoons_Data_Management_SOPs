...
cat("-- Use the SELECT queries below to determine if the Lagoons in Deliverable L11 exist or not. These lagoons must exist to avoid database errors when inserting data later on. If a lagoon doesn't exist, check the spelling. If it still doesn't exist, use the relevant INSERT query to insert it.\n")
